...
class HwwProcessor_Mu(processor.ProcessorABC):
    ...
    def process(self, df):
        ...
        selection.add('jetkin', leadingjet.pt>300)
        ...
        selection.add('LSF3medium', (leadingjet.lsf3>0.78).any())
        ...
        df['jet_pt'] = leadingjet.pt
        df['jet_lsf3'] = leadingjet.lsf3
        df['jet_mmass'] = jmass
        df['jet_hmass'] = (met_p4 + leadingjet).mass
        df['jet_oppbtag'] = ak4_opposite.btagDeepB.max()
        df['muon_pt'] = leadingmuon.pt
        df['muon_miso'] = leadingmuon.miniPFRelIso_all
        df['met_pt'] = met.pt
        df['met_eta'] = met_p4.eta

        # fill cutflow
        cutflow = ['trigger', 'jetkin', 'onemuon', 'antibtag', 'LSF3muinside', 'LSF3medium']
        allcuts = set()
        ...
        regions['lepsel'] = {'trigger','jetkin', 'onemuon','antibtag','LSF3muinside','LSF3medium'}
